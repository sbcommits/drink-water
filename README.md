...
A large cup that fills and caculates the remaining amount left to fill from 8 smaller cups.
...
This is day 16 of the '50 Projects In 50 Days' Udemy course by Brad Traversy and Florin Pop.
...
- Clicking a cup will add the amount into the larger cup
- Clicking the same cup will remove the amount of that cup
